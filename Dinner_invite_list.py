#Print name
names=["Yuvan","Deva","Rahman","Ilayaraja","Harris"]
for name in names:
    print(name)

#Q2
for name in names:
    print(f"My fav music director is {name}")
    
#Q:3a
Series=["Friends","Modern family","Big Bang theory"]
print(f"My fav series is {Series[0]}")

#Q:3b
print(f"Hi Christopher Lloyd,I like {Series[1]} bcz of its family comedies")
